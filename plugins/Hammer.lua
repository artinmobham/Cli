...
local function kick_ban_res(extra, success, result)
      ...
      elseif get_cmd == 'banall' then
        send_large_msg(receiver, 'User @'..member..' ['..member_id..'] globally hammered🚧 | Database reloaded⚠')
		banall_user(member_id)
      elseif get_cmd == 'unbanall' then
        send_large_msg(receiver, 'User @'..member..' ['..member_id..'] globally unhammered🚧 | Database reloaded⚠')
